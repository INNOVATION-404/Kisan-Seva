...
public class IncomeAdapter extends ArrayAdapter<Income> implements View.OnClickListener{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Income expense = getItem(position);
        ...
        String landname="";
        if(mContext instanceof IncomeActivity){ landname=((IncomeActivity) mContext).getLandName(expense.getLandid());}
        viewHolder.landname.setText(landname);
        viewHolder.expenseamount.setText("+ \u20B9 "+expense.getCost());
        viewHolder.expenseamount.setTextColor(Color.parseColor("#34af23"));
